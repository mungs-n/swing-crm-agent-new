const PATHS = {
  gift: (
    <>
      ...
      <path d="M12 6c-1.5-3-6-3-6-.5S9 6 12 6z" />
      <path d="M12 6c1.5-3 6-3 6-.5S15 6 12 6z" />
    </>
  ),
  cart: (
    <>
  ...
  "heart-alert": (
    <>
      <path d="M12 20s-7-4.35-9.5-8.5C.7 8 2.3 4.5 6 4.5c2 0 3.3 1.2 4 2.2.7-1 2-2.2 4-2.2 3.7 0 5.3 3.5 3.5 7C19 15.65 12 20 12 20z" />
  ...
  tag: (
    <>
      <path d="M3 11.5V5a2 2 0 0 1 2-2h6.5L21 11.5a2 2 0 0 1 0 2.8l-6.7 6.7a2 2 0 0 1-2.8 0L3 12.7z" />
...
export default function RecipeArt({ art, className = "", size = 28 }) {
  return (
    <svg
      className={className}
      width={size}
